...
public class CustomerData {
    ...
    public CustomerData() {
        this.jsonFilePath = "C:\\Users\\Usuario\\Documents\\Progra2\\ProyectoProgra1\\Proyecto I PROGRAMACIÓN II\\ParkingSystem\\customers.json";
    }
    ...
    public Customer getCustomerByUsername(String username) throws ParseException, org.json.simple.parser.ParseException {
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (jsonObject.get("username").toString().equalsIgnoreCase(username)) {
                    customer.setIdentification((String) jsonObject.get("identification"));
                    ...
                    customer.setDisabilityPresented(Boolean.parseBoolean((String)jsonObject.get("disabilityPresented")));
                }
